          ...
          return (
            <div key={index}>
              <button
                ...
                className={`relative flex cursor-pointer items-center ${sidebarCollapsed ? 'gap-0 justify-self-center px-3' : 'w-full justify-start gap-3 pr-2 pl-3'} py-0.3 min-h-[2.5rem] rounded-lg text-xs font-medium transition-all duration-200 ease-out ${
                  isActive
